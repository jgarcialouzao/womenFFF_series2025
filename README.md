...
## Results
  ...
  * `3_oster.do     `                  - estimates Oster approach (Table 3, Column 4)
  * `3_oster_heterogeneity.do` - implements Oster approach for different levels of heterogeneity (Tables 4 and 5), and supplementary material in the online appendix.
